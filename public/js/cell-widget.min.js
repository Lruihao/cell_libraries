...
"Delete file").on("click",function(){p(a)}).tooltip();$(document.createElement("i")).appendTo(b).addClass("fa fa-trash-alt")}},l=a=>{a.list=new Cell.Grid({appendTo:a._domNode,url:a.options.url,query:a.options.query,headerSticky:!1,identify:"displayId",selector:!0,fields:[{name:"displayId",hidden:!0},{name:"id",hidden:!0},{name:"size",hidden:!0},{name:"name",label:"File",formatter:function(b,c,e){if(!0!==a.options.displaySize)return e;let f=document.createElement("div");$(f).appendTo(c);$(document.createElement("span")).appendTo(f).html(e);
$(document.createElement("span")).appendTo(f).addClass("size").html($c.file.formatBytes(this.getItemData(b,"size")))}},{name:"message",label:"Status",formatter:function(b,c,e){e&&(b=this.getItemData(b,"id"),$(c).html(e.message||n(e.code)),$(c).removeClass("uploading"),-1<Number(e.code)&&$(c).addClass("status-"+e.code),0===e.code&&b&&$(document.createElement("input")).appendTo(c).attr("type","hidden").attr("name",a.options.name+"[]").val(b))}}],emptyMessage:a.options.emptyMessage||"No files.",onselected:function(b){$(a._domNode).find(".cell-grid-toolbar .cell-btn-circle").toggleClass("d-none",
!b.length)},onload:function(){!a.options.multiple&&1<this.getItemCount()&&this.removeItems(this.getItemId(this.getFirstItem()))}})},e=a=>{$(a.options.dragPanel).on("drag dragstart dragend dragover dragenter dragleave drop",function(a){a.preventDefault();a.stopPropagation()}).on("dragenter",function(){$(this).addClass("cell-uploader-dragover");a._dragCounter++}).on("dragleave",function(){a._dragCounter--;0===a._dragCounter&&$(this).removeClass("cell-uploader-dragover")}).on("drop",function(b){!0===
a.options.clearOnDrag&&a.reload();a._dragCounter=0;$(this).removeClass("cell-uploader-dragover");a._droppedFiles=b.originalEvent.dataTransfer.files;c(a)})},a=a=>{$c.ajax.get({url:a.options.fileTypeUrl||$c.router("//file_manager/extensions"),success:function(b){$("#cell-uploader-input"+a._idx).attr("accept",a.options.accept?`${a.options.accept},${b.types}`:b.types);a.options.fileType=b.exts;Array.isArray(a.options.fileType)&&$(a._domNode).find(".cell-uploader-filetype").html(a.options.fileType.join(", "))}})},
c=a=>{let b=new FormData(a.options.data);if(a._droppedFiles){!0!==a.options.multiple&&(a.reload(),a._droppedFiles=[a._droppedFiles[0]]);var c=[];$.each(a._droppedFiles,(e,f)=>{e=a.list.addItem({id:null,name:f.name,size:f.size},!0);c.push(e);b.append("display_ids[]",e);b.append("files[]",f)});$c.ajax.post({url:a.options.uploadUrl,data:b,cache:!1,contentType:!1,processData:!1,xhr:function(){$(a._domNode).find(".cell-uploader-input").val(null);let b=$.ajaxSettings.xhr();b.upload&&b.upload.addEventListener("progress",
function(b){b.lengthComputable&&(b=(100*b.loaded/b.total).toFixed(2),a.list.setItemColVal(c,"message",{code:-1,message:"\u4e0a\u50b3\u4e2d ("+b+"%)"}))},!1);return b},success:function(b){$.each(b,function(b,c){a.list.setItemColVal(b,"id",c.id||null);a.list.setItemColVal(b,"message",{code:c.err_code,message:c.message})});0===b.length&&$.each(c,function(b,c){a.list.setItemColVal(c,"message",{code:99,message:"\u4e0d\u660e\u7684\u932f\u8aa4\uff0c\u8acb\u6aa2\u67e5\u4f3a\u670d\u5668\u8a2d\u5b9a"})});a.options.onuploaded&&
a.options.onuploaded.call(a,b)}})}},n=a=>{switch(a){case 0:return"\u4e0a\u50b3\u5b8c\u6210";case 1:return"\u4e0a\u50b3\u5931\u6557\uff1a\u6a94\u6848\u5927\u5c0f\u8d85\u51fa\u9650\u5236 "+a;case 2:return"\u4e0a\u50b3\u5931\u6557\uff1a\u6a94\u6848\u5927\u5c0f\u8d85\u51fa\u9650\u5236 "+a;case 8:return"\u4e0a\u50b3\u5931\u6557\uff1a\u4e0d\u5141\u8a31\u7684\u6a94\u6848\u985e\u578b";case 9:return"\u4e0a\u50b3\u5931\u6557\uff1a"+a;default:return"\u4e0a\u50b3\u5931\u6557\uff1a"+a}},p=a=>{let b=a.list.getSelectionVal("displayId"),
c=a.list.getSelectionVal("id");if(0===c.length)return a.list.removeItems(b),this;$c.ajax.delete({url:a.options.removeUrl,data:{ids:c},success:function(){a.list.removeItems(b)}});return this};return g}();
